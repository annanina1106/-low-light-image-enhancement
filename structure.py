...
# def process_structure(v_channel, sigma=75):
#     """
#     Modality B: Structure
#     接受 sigma 參數以便 GUI 調整降噪強度
#     """
#     # [cite_start]雙邊濾波 (Bilateral Filter) [cite: 25]
#     if sigma is None: sigma = 75
    
#     v_smooth = cv2.bilateralFilter(v_channel, d=9, sigmaColor=sigma, sigmaSpace=sigma)

#     # [cite_start]Sobel 算子提取邊緣 [cite: 26]
